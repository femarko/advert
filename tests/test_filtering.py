...
@pytest.mark.parametrize("params", (
        ...
        #   "column": "name",
        #   "column_value": "test_filter_1000"}, ["Unexpected or missing 'comparison' parameter."]),
        # ({"model_class": models.User,
        #   "filter_type": "column_value",
        #   "comparison": "is",
        #   "column": "wrong_param",
        #   "column_value": "test_filter_1000"}, ["Unexpected or missing 'column' parameter."]),
        # ({"model_class": models.User,
        #   "filter_type": "column_value",
        #   "comparison": "is",
        #   "column": "name",
        #   "column_value": "wrong_param"}, None),
        # ({"model_class": "wrong_paramm",
        #   "filter_type": "wrong_param",
        #   "comparison": "wrong_param",
        #   "column": "wrong_param",
        #   "column_value": "wrong_param"}, ["Unexpected or missing 'model_class' parameter."]),
        # ({"model_class": models.User,
        #   "filter_type": "wrong_param",
        #   "comparison": "wrong_param",
        #   "column": "wrong_param",
        #   "column_value": "wrong_param"}, ["Unexpected or missing 'column' parameter.",
        #                                    "Unexpected or missing 'filter_type' parameter."]),
        # ({"model_class": models.User,
        #   "filter_type": "column_value",
        #   "comparison": "wrong_param",
        ...
        #   "comparison": "wrong_param",
        #   "column": "name",
        #   "column_value": "test_filter_1000"}, ["Unexpected or missing 'filter_type' parameter."]),
...
@pytest.mark.parametrize(
    ...
    (
            ({"model_class": "wrong_paramm",
              ...
              "comparison": "is",
              "column": "name",
              "column_value": "test_filter_1000"}, ["Unexpected or missing 'model_class' parameter."]),
            ({"model_class": models.User,
              "filter_type": "wrong_param",
              "comparison": "is",
              "column": "name",
...
def test__query_object_with_wrong_params(
        session_maker, create_test_users_and_advs, wrong_params, expected_error_message
):
    session = session_maker
    with session() as sess:
    ...
    # assert query_result.query_object == []
